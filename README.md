...
setcol() # <color code>
# set text color - see VT100 color codes provided.
...
Putting "$UTS_FORCEFLAG" as the first arguments to a script call 'forces' the functions to skip user input (e.g. like rm -f does).
END_UIO
);
